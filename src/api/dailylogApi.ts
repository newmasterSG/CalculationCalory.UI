...
export const dailyLogApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        getDailyLogByUser: builder.query<Record<MealType, MealItem[]>, GetDailyLogByUserQuery>({
            query: (command) => ({
...
export const { useAddMealItemToLogMutation, useGetDailyLogByUserQuery } = dailyLogApi