...
export const ListProductPopUp = forwardRef<HTMLElement, ListProductProps>(
  ({ items, handleAddProductToList, handleNewView }, ref) => {
        ...
        {selectedProduct ? (
          ...
          <List>
            {filteredProducts.map((product, index) => (
              ...
              >
                <ListItemText
                  ref={filteredProducts.length === index + 1 ? ref : null}
